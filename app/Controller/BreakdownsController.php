...
class BreakdownsController extends AppController{
    ...
    private function init_categories($location){
        ...
        elseif($location['Location']['name']=='赤羽店'){
            $arr = ["ソフトドリンク", "割り物", "焼酎ボトル", "焼酎グラス", "サワー・カクテル", "サワー&カクテル", "ウイスキー", "ウィスキー", "ワイン", "日本酒", "ビール", "飲み放題", "ドリンクその他"];
        }
        elseif($location['Location']['name']=='東池袋店'){
            $arr = ["ランチドリンク", "カフェドリンク", "ビール", "日本酒", "焼酎", "サワー・カクテル", "サワー&カクテル", "ワイン", "ウイスキー", "ウィスキー", "ソフトドリンク", "飲み放題", "リキュール", "割り物/セット", "ノンアルコール"];
        }
		elseif($location['Location']['name']=='池袋東武店'){
			$arr = ["ランチドリンク", "カフェドリンク", "ビール", "日本酒", "焼酎", "サワー・カクテル", "サワー&カクテル", "ワイン", "ウイスキー", "ウィスキー", "ソフトドリンク", "飲み放題", "リキュール", "割り物/セット", "ノンアルコール"];
		}
        return $arr;
    }
